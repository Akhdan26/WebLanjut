        ...
        <div class="col-md-8">
            <div class="input-group mb-3">
                ...
                <div class="input-group-append">
                    <button class="btn btn-primary ml-2" type="button" id="btn-search">
...
<!-- Modal -->
<div class="modal fade" id="exmapleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
